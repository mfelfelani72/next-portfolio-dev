...
export default function Projects() {
  ...
  const addProject = () =>
    setProjects([
      ...projects,
      { title: "", description: "", link: "", technologies: [], image: "" },
    ]);
                ...
                {projects.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-semibold text-gray-600 dark:text-gray-400 mb-2">
                      {t("no_projects_registered")}
                    </h3>
                    <p className="text-gray-500 dark:text-gray-500 text-sm mb-6">
                      {t("add_first_projects")}
                    </p>
                    <button
                      onClick={addProject}
                            ...
                            <div className="space-y-4">
                              <div>
                                ...
                                <input
                                  ...
                                  placeholder={t("title_project_ex")}
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <textarea
                                  ...
                                  placeholder={t("description_project_ex")}
                                  rows={4}
