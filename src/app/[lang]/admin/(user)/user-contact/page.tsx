...
export default function Contact() {
  ...
  useEffect(() => {
    if (data) {
      ...
      // مطمئن شیم همه فیلدها شامل telegram هستن
      setContact({
        email: data.email || "",
        linkedin: data.linkedin || "",
        github: data.github || "",
        telegram: data.telegram || "", // این خط مهمه
      });
    }
  }, [data]);
  ...
  const getFieldPlaceholder = (field: keyof Contact) => {
    switch (field) {
      ...
      case "telegram":
        return "https://t.me/username"; // اینم باید باشه
      default:
        return "";
    }
  };
  ...
  // لیست فیلدها رو چک کنیم
  const contactFields: (keyof Contact)[] = ['email', 'linkedin', 'github', 'telegram'];
