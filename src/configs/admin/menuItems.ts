  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        id: "3-2",
        title: "دسته‌بندی‌ها",
        icon: `<svg xmlns="http://wsrc/configs/menuItems copy.tsww.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 18 6-6-6-6"/><path d="M8 6v12"/></svg>`,
